...
local FOLDER_NAME = "NebulaXHub Script"
...
local function BuildInterface(isReload)
    ...
    if isReload then
        SendNotification("Nebula Script Reloaded Successfully", Theme.Green)
    else
        SendNotification("Nebula Script Loaded Successfully", Theme.Accent)
    end
end
